...
class HRL_Sync_Plugin {
  ...
  public function sc_public_library($atts) {
    $frontend_url = get_option('hrl_sync_frontend_url', 'https://sync.hardbanrecordslab.online');
  ...
  public function sc_channel($atts) {
    ...
    $api  = esc_url(get_option('hrl_sync_api_url', 'https://sync-api.hardbanrecordslab.online'));
  ...
  public function settings_page() { ?>
    <div class="wrap">
          ...
          <tr>
            ...
            <td>
              <input type="url" name="hrl_sync_api_url" class="regular-text"
                value="<?php echo esc_attr(get_option('hrl_sync_api_url','https://sync-api.hardbanrecordslab.online')); ?>">
          ...
          <tr>
            ...
            <td>
              <input type="url" name="hrl_sync_frontend_url" class="regular-text"
                value="<?php echo esc_attr(get_option('hrl_sync_frontend_url','https://sync.hardbanrecordslab.online')); ?>">
            </td>
          </tr>
          <tr>
            <th>Default Theme</th>
      ...
      function testConn(){
        ...
        fetch('<?php echo esc_url(get_option('hrl_sync_api_url','https://sync-api.hardbanrecordslab.online')); ?>/health')
          .then(r=>r.json())
  ...
  public function block_editor() {
    ...
    wp_localize_script('hrl-sync-block', 'hrlSyncConfig', [
      'apiUrl'       => get_option('hrl_sync_api_url', 'https://sync-api.hardbanrecordslab.online'),
...
register_activation_hook(__FILE__, function() {
  add_option('hrl_sync_api_url',      'https://sync-api.hardbanrecordslab.online');
  add_option('hrl_sync_frontend_url', 'https://sync.hardbanrecordslab.online');
