-- ═══════════════════════════════════════════════════════════════════════════
-- HRL Sync — PostgreSQL schema (single source of truth, run on every boot)
-- Idempotent: safe to run repeatedly. Applied automatically by migrate.js
-- ═══════════════════════════════════════════════════════════════════════════
...
DO $$ DECLARE t TEXT;
BEGIN
  FOR t IN SELECT unnest(ARRAY['users','tracks','lyrics','contacts','playlists','projects','embed_settings'])
  LOOP
