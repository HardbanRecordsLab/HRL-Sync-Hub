  ...
  async send({ to, subject, html, text }) {
    ...
    try {
      const info = await this.transporter.sendMail({
        from: process.env.EMAIL_FROM || "HRL Sync <sync@hardbanrecordslab.online>",
...
<body>
  <div class="wrap">
    ...
    <div class="footer">HRL SYNC · HARDBAN RECORDS LAB · <a href="https://hardbanrecordslab.online" style="color:#6E648C">hardbanrecordslab.online</a></div>
  </div>
</body>
</html>`;
