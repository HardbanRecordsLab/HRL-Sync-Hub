...
sync.hardbanrecordslab.online  Port 3001 → Nginx 443         Lyrics (Docs)
                           sync-api.hardbanrecordslab.online
                                    ↑
...
FRONTEND_URL=https://sync.hardbanrecordslab.online
...
| `VITE_API_URL` | `https://sync-api.hardbanrecordslab.online` |
