        ...
        <Layout>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Card className="bg-card/50 border-white/5 overflow-hidden group hover:border-violet-500/20 transition-all">
                        <CardHeader className="pb-3">
                            <div className="w-10 h-10 rounded bg-violet-500/10 flex items-center justify-center mb-2">
                        ...
                        <CardContent>
                            <Button variant="outline" className="w-full gap-2 group-hover:bg-violet-500 group-hover:text-white transition-colors">
                ...
                <div className="bg-violet-500/5 border border-violet-500/10 rounded-lg p-6 mt-8">
                    ...
                    <div className="flex gap-4">
                        <div className="px-3 py-1 bg-violet-500/10 text-violet-500 text-xs rounded border border-violet-500/20 flex items-center gap-2">
